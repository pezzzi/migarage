...
<body>
  ...
  <div class="contenedor-principal">
    ...
    <form action="registro.php" method="post" enctype="multipart/form-data">
      ...
      <label class="etiqueta" for="userName">Nombre y apellido:
      <input type="text" id="userName" placeholder="Nombre completo"  name="userName" value="<?php echo isset($_POST["userName"]) ? $_POST["userName"] : ''; ?>"><span class="required"> *</span>
      <span class="error"> <?php echo $errorName;?> </span>
      </label>

      <br><br>

      <label class="etiqueta" for="username">Nombre de usuario:
      <input  id="username" type="text" name="username" placeholder="Nombre de usuario" value="<?php echo isset($_POST["username"]) ? $_POST["username"] : ''; ?>"><span class="required"> *</span>
      </label>

      <br><br>

      <label class="etiqueta" for="">Contraseña:
      <input type="password" name="userPass" minlength="5" value="<?php echo isset($_POST["userPass"]) ? $_POST["userPass"] : ''; ?>"><span class="required"> *</span>
      <span class="error"> <?php echo $errorPass;?> </span>
      </label>

      <br><br>

      <label class="etiqueta" for="">Confirmar contraseña:
      <input type="password" name="userPassConfirmation" mixlength="5"><span> *</span>
      ...
      <label class="etiqueta">Email:
      <input type="email"  name="userEmail" value="<?php echo isset($_POST["userEmail"]) ? $_POST["userEmail"] : ''; ?>"><span class="required"> *</span>
      <span class="error"> <?php echo $errorEmail;?> </span>
      </label>

      <br><br>

      <label class="etiqueta" for="userAvatar">Subi tu Avatar:
      <input type="file" id="userAvatar" name="userAvatar" class="btn" value="">
